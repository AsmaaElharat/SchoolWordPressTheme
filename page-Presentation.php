...
<div class="classes-wrapper">
        ...
        <div class="class-container class-container-pink">
            ...
            <img src="<?php bloginfo('template_url')?>/images/génie-info.ico" class="instructor-headshot" alt="">
            <div class="class-container-content">
                <div class="class-instructor-section">
                    <h3>Chef de département</h3>
                    <p class="instructor-name">Dr.Baddi Youssef</p>
                </div>
        ...
        <div class="class-container class-container-purple">
            ...
            <img src="<?php bloginfo('template_url')?>/images/management.ico" class="instructor-headshot" alt="">
            <div class="class-container-content">
                <div class="class-instructor-section">
                    <h3>Chef de département</h3>
                    <p class="instructor-name">Dr.Adil ElAmri</p>
                </div>
                <div class="class-length-section">
                    <h3>Durée</h3>
                    <p class="length">2 ans</p>
        ...
        <div class="class-container class-container-green">
            ...
            <img src="<?php bloginfo('template_url')?>/images/agroenvironnement.ico" class="instructor-headshot" alt="">
            <div class="class-container-content">
                <div class="class-instructor-section">
                    <h3>Chef de département</h3>
                    <p class="instructor-name">Dr.</p>
                </div>
                <div class="class-length-section">
                    <h3>Durée</h3>
                    <p class="length">2 ans</p>
